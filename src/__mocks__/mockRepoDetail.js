...
const MOCK_README = [
    ...
    '```mermaid',
    'flowchart LR',
    '    A[Ingestion] --> B[Feature Engineering]',
    '    B --> C[Scoring]',
    '    C --> D[(Results DB)]',
    '```',
    '',
