                    ...
                    {activeFile ? (
                        <div className="min-w-0">
                            <div className="sticky top-0 z-10 flex items-center gap-2 px-4 py-2 bg-white/95 dark:bg-slate-900/95 backdrop-blur border-b border-slate-100 dark:border-slate-800 text-xs">
                                ...
                                <span className="flex-shrink-0 text-emerald-700 dark:text-emerald-400">+{activeFile.additions}</span>
                                <span className="flex-shrink-0 text-rose-600 dark:text-rose-400">−{activeFile.deletions}</span>
                            </div>
                            {activeFile.patch ? (
