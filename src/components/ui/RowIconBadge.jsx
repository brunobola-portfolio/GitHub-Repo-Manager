...
const SOLID_TONES = {
    ...
    indigo:  'bg-indigo-100 dark:bg-indigo-900/30 text-[color:var(--ds-accent-brand)] dark:text-[color:var(--ds-accent-brand-dark)]',
...
const SOFT_TONES = {
    ...
    indigo:  'bg-indigo-500/10  text-[color:var(--ds-accent-brand)] dark:text-[color:var(--ds-accent-brand-dark)]',
