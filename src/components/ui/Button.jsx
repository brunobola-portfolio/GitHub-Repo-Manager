...
const variants = {
    ...
    'outline-primary': 'bg-transparent text-indigo-600 dark:text-indigo-400 border border-indigo-300 dark:border-indigo-700 hover:bg-indigo-50 dark:hover:bg-indigo-900/30 ds-focus-ring',
