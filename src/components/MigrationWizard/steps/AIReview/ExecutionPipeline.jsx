      ...
      <div className="space-y-1.5">
        {order.map((name, i) => {
          ...
          return (
            ...
            >
              {/* Step number */}
              <span className="shrink-0 w-6 h-6 rounded-md bg-[color:var(--ds-accent-brand)] dark:bg-indigo-500 text-white flex items-center justify-center ds-text-meta font-bold shadow-sm">
                {i + 1}
              </span>
