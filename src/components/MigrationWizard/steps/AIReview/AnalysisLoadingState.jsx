    ...
    >
      ...
      >
        <div className="relative">
          <motion.div
            className="w-11 h-11 rounded-xl bg-[color:var(--ds-accent-brand)] dark:bg-[color:var(--ds-accent-brand-fill-dark)] flex items-center justify-center ds-elevation-md"
