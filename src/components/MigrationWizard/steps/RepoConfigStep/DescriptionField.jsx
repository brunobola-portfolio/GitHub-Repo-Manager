      ...
      <div className="flex items-center justify-between gap-2 mb-1.5">
        ...
        <button
          ...
          className={`group inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg ds-text-meta font-semibold shrink-0
            ...
            ${aiAvailable
              ? 'text-white bg-gradient-to-br from-brand-500 to-brand-600 hover:from-brand-400 hover:to-brand-500 ds-elevation-sm hover:shadow-md hover:shadow-brand-500/20'
