        ...
        >
          <ul className="py-1">
              ...
              return (
                <li key={p.id}>
                  ...
                  >
                    ...
                    <span className="ds-text-meta text-slate-500 dark:text-slate-400 tabular-nums">{count}</span>
                  </button>
                </li>
              )
            })}
            ...
            <li>
              ...
              >
                <Pencil className="w-3.5 h-3.5 text-brand-500 dark:text-[color:var(--ds-accent-brand-dark)]" aria-hidden="true" />
                Select by pattern…
              </button>
            </li>
          </ul>
