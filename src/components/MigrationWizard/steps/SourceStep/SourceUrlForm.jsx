            ...
            <div className="mt-2.5 rounded-2xl border border-indigo-200 dark:border-indigo-800 bg-indigo-50/60 dark:bg-indigo-900/15 overflow-hidden">
              ...
              <div className="px-3.5 py-2.5 flex items-center gap-3">
                ...
                <button
                  type="button"
                  onClick={onApply}
                  className="shrink-0 inline-flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold rounded-lg bg-[color:var(--ds-accent-brand)] text-white hover:bg-[color:var(--ds-accent-brand-hover)] dark:bg-indigo-500 dark:hover:bg-indigo-400 shadow-sm transition-colors"
                >
