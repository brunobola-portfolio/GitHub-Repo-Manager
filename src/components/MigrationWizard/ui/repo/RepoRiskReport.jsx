                    ...
                    {f.actions.map((a) => (
                      a.href ? (
                        <a
                          ...
                          className="inline-flex items-center gap-1 px-2 py-0.5 ds-text-meta font-medium rounded bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-200 hover:bg-slate-200 dark:hover:bg-slate-700 ds-focus-ring"
                        >
                          {a.label}
                        </a>
                      ) : (
