    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="min-h-[400px] flex items-center justify-center bg-slate-50 dark:bg-slate-900/50 rounded-2xl p-6">
          <div className="max-w-md w-full bg-white dark:bg-slate-800 rounded-2xl ds-elevation-lg p-8 text-center">
            <div className="w-14 h-14 bg-rose-50 dark:bg-rose-900/30 rounded-2xl flex items-center justify-center mx-auto mb-4">
