...
export function AppLogo({ className = 'w-6 h-6', style }) {
  return (
    ...
    >
      ...
      {/* Connection lines */}
      <line x1="256" y1="240" x2="370" y2="142" stroke="#818cf8" strokeWidth="3" strokeLinecap="round" opacity="0.7" />
      <line x1="256" y1="240" x2="148" y2="152" stroke="#a78bfa" strokeWidth="3" strokeLinecap="round" opacity="0.6" />
      <line x1="256" y1="240" x2="155" y2="358" stroke="#c084fc" strokeWidth="2.5" strokeLinecap="round" opacity="0.5" />
      <line x1="256" y1="240" x2="368" y2="348" stroke="#22d3ee" strokeWidth="2.5" strokeLinecap="round" opacity="0.6" />

      {/* Node-to-node arcs */}
      <path d="M370 142 Q 410 245, 368 348" stroke="#22d3ee" strokeWidth="1.5" fill="none" opacity="0.25" strokeLinecap="round" />
      <path d="M148 152 Q 100 250, 155 358" stroke="#a78bfa" strokeWidth="1.5" fill="none" opacity="0.2" strokeLinecap="round" />

      {/* Outer nodes */}
      {/* Top-right: cyan (primary) */}
      <circle cx="370" cy="142" r="24" fill="none" stroke="#22d3ee" strokeWidth="2" opacity="0.3" />
      <circle cx="370" cy="142" r="16" fill="#22d3ee" />
      <circle cx="370" cy="142" r="8" fill="white" opacity="0.7" />

      {/* Top-left: indigo */}
      <circle cx="148" cy="152" r="20" fill="none" stroke="#a78bfa" strokeWidth="1.5" opacity="0.25" />
      <circle cx="148" cy="152" r="13" fill="#a5b4fc" />
      <circle cx="148" cy="152" r="6" fill="white" opacity="0.6" />

      {/* Bottom-left: purple */}
      <circle cx="155" cy="358" r="18" fill="none" stroke="#c084fc" strokeWidth="1.5" opacity="0.2" />
      <circle cx="155" cy="358" r="11" fill="#c084fc" />
      <circle cx="155" cy="358" r="5" fill="white" opacity="0.5" />

      {/* Bottom-right: teal */}
      <circle cx="368" cy="348" r="19" fill="none" stroke="#06b6d4" strokeWidth="1.5" opacity="0.25" />
      <circle cx="368" cy="348" r="12" fill="#22d3ee" />
      ...
      <g transform="translate(256,240)" opacity="0.95">
        ...
        <line x1="-12" y1="-6" x2="12" y2="-6" stroke="#6366f1" strokeWidth="1.5" opacity="0.4" />
      </g>

      {/* Sparkle atmosphere */}
      <circle cx="310" cy="190" r="2" fill="white" opacity="0.4" />
      <circle cx="200" cy="300" r="1.5" fill="white" opacity="0.3" />
      <circle cx="330" cy="290" r="1.5" fill="#22d3ee" opacity="0.4" />
      <circle cx="190" cy="200" r="1.5" fill="#a78bfa" opacity="0.35" />
    </svg>
  )
}
