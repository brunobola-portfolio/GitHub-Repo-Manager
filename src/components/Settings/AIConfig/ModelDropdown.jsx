        ...
        >
            ...
            {sections.length === 0 ? (
                <div className="px-3 py-4 text-xs text-slate-500 dark:text-slate-400">
                    {activeTier
                        ? <>No models in this tier. <button type="button" onClick={() => setActiveTier(null)} className="text-[color:var(--ds-accent-brand)] dark:text-brand-300 hover:underline">Clear filter</button>.</>
