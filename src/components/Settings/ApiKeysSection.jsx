...
function NewKeyReveal({ keyData, onDismiss }) {
    ...
    return (
        ...
        >
            ...
            <button
                onClick={onDismiss}
                className="w-full py-2 text-sm font-medium text-slate-600 dark:text-slate-300 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors ds-focus-ring"
            >
                I've saved the key
            </button>
        </motion.div>
                ...
                {confirming ? (
                    <div className="flex items-center gap-1.5">
                        ...
                        <button
                            ...
                            disabled={revoking}
                            className="px-2.5 py-1 text-xs font-medium text-white bg-rose-600 hover:bg-rose-700 disabled:opacity-50 rounded-lg transition-colors ds-focus-ring"
                        >
                            {revoking ? 'Revoking...' : 'Yes'}
                        </button>
                        <button
                            onClick={() => setConfirming(false)}
                            className="px-2.5 py-1 text-xs font-medium text-slate-600 dark:text-slate-300 bg-slate-100 dark:bg-slate-700 hover:bg-slate-200 dark:hover:bg-slate-600 rounded-lg transition-colors ds-focus-ring"
                        >
                            No
                        </button>
                    </div>
                    ...
                    <button
                        ...
                        disabled={isRevoked}
                        className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-rose-700 dark:text-rose-400 bg-rose-50 dark:bg-rose-900/20 hover:bg-rose-100 dark:hover:bg-rose-900/30 disabled:opacity-40 disabled:cursor-not-allowed rounded-xl transition-colors ds-focus-ring"
                    >
