        ...
        <div className={`relative isolate group ${className}`}>
            ...
            <Tooltip label="Open on GitHub">
                <a
                    ...
                    className="absolute top-2 right-2 z-10 p-1.5 rounded-md text-slate-400 hover:text-brand-600 dark:hover:text-brand-400 hover:bg-slate-100 dark:hover:bg-slate-800 opacity-100 sm:opacity-0 sm:group-hover:opacity-100 sm:focus-visible:opacity-100 transition-opacity ds-focus-ring"
                >
