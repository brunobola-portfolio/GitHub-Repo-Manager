        ...
        <div className="space-y-2 max-h-72 overflow-auto">
            {pulls.map(pr => (
                <button
                    ...
                    type="button"
                    onClick={() => onSelect(pr)}
                    className="w-full text-left p-3 rounded-xl border border-slate-200 dark:border-slate-700 hover:border-brand-400 dark:hover:border-brand-500 hover:bg-slate-50 dark:hover:bg-slate-800/40 transition-colors ds-focus-ring"
                >
