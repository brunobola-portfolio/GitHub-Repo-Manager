    ...
    return (
        ...
        >
            ...
            <div className="flex justify-end gap-2 px-3 py-2 border-t border-amber-200 dark:border-amber-800/50">
                <button type="button" onClick={onDismiss} className="px-3 py-1 text-xs rounded-md text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-300 ds-focus-ring">Dismiss</button>
