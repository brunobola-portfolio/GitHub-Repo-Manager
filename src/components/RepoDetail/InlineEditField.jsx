...
const INPUT_CLASSES = 'w-full px-2 py-1 -mx-2 -my-1 rounded-md bg-white dark:bg-slate-800 border border-brand-400 dark:border-brand-500 text-slate-900 dark:text-slate-100 text-sm ds-focus-ring transition-colors'
