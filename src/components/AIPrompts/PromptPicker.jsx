        ...
        <div ref={containerRef} className="relative inline-block text-xs">
            ...
            {open ? (
                <ul
                    ...
                    className="absolute right-0 mt-1 w-56 max-h-64 overflow-y-auto rounded-md border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 ds-elevation-lg z-[var(--ds-z-floating)]"
                >
                    {presets.map((p, idx) => (
                        <li
                            key={p.id}
