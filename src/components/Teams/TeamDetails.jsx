                                ...
                                <div className="relative">
                                    ...
                                    {userSearchResults.length > 0 && (
                                        <div
                                            ...
                                            className="absolute z-[var(--ds-z-popover)] top-full mt-2 left-0 w-full bg-white dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700 ds-elevation-overlay max-h-60 overflow-y-auto"
                                        >
                                            {userSearchResults.map(u => (
                                                <button
                                                    ...
                                                    className="w-full flex items-center gap-3 p-3 hover:bg-brand-50 dark:hover:bg-brand-900/20 text-left transition-colors border-b border-slate-100 dark:border-slate-700 last:border-0 ds-focus-ring rounded"
                                                >
                                        ...
                                        {missingMembers.map(m => (
                                            <div key={m.username} className="flex items-center justify-between text-xs bg-slate-50 dark:bg-slate-700/30 p-1.5 rounded-lg border border-slate-100 dark:border-slate-700">
                                                ...
                                                <button
                                                    ...
                                                    className="px-2 py-0.5 bg-brand-100 text-brand-700 dark:bg-brand-900/50 dark:text-[color:var(--ds-accent-brand-dark)] rounded hover:bg-brand-200 dark:hover:bg-brand-900 transition-colors disabled:opacity-50 ds-focus-ring"
                                                >
