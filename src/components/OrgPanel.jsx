	    ...
	    return (
	        <Card className="p-4 space-y-4">
	            ...
	            <div className="flex items-center justify-between">
	                <h3 className="text-sm font-semibold text-slate-500 dark:text-slate-300 uppercase tracking-wide flex items-center gap-2">
	            ...
	            <div className="space-y-1">
	                <button
	                    ...
	                    className={`w-full flex items-center gap-3 p-3 rounded-lg transition-all ${
	                        selectedOrg === null
	                            ? 'bg-indigo-50 text-indigo-800 border-2 border-indigo-200 shadow-sm dark:bg-indigo-900/40 dark:text-indigo-100 dark:border-indigo-500'
	                            : 'hover:bg-slate-50 text-slate-700 border-2 border-transparent dark:text-slate-200 dark:hover:bg-slate-800'
	                    }`}
	                >
	                    {user?.avatar_url && (
                ...
                {orgs.map(org => (
                    <div key={org.login} className="relative group">
	                        ...
	                        <button
	                            ...
	                            className="absolute right-2 top-1/2 -translate-y-1/2 p-1.5 rounded-md opacity-0 group-hover:opacity-100 hover:bg-slate-200 dark:hover:bg-slate-700 transition-all"
	                        >
	            ...
	            <div className="pt-3 border-t border-slate-200 dark:border-slate-700 space-y-1">
	                <a
	                    ...
	                    target="_blank"
	                    rel="noopener noreferrer"
	                    className="flex items-center gap-2 text-xs text-slate-500 dark:text-slate-400 hover:text-indigo-600 dark:hover:text-indigo-300 transition-colors p-2 rounded hover:bg-slate-50 dark:hover:bg-slate-800"
	                >
