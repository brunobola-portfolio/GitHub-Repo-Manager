...
| Call the API | [API reference](api/API.md) (342 route handlers — recounted via `grep`, see API.md header) |
...
- [API Reference](api/API.md) — 342 route handlers across 76 route
