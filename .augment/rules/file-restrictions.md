---
type: always
description: Strict file creation restrictions to prevent unnecessary file generation
---
...
1. Use str-replace-editor tool, never recreate files from scratch
2. Make minimal changes necessary to achieve the goal
3. Preserve existing code style and patterns
4. Update all affected downstream code (callers, tests, types)
