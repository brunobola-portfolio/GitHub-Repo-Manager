...
function err(status, body = {}) { return { ok: false, status, headers: { get: () => 'application/json' }, json: async () => body } }
...
describe('useWorkBoardPresets', () => {
    ...
    it('create posts and refreshes', async () => {
        ...
        global.fetch.mockResolvedValueOnce(csrf()) // CSRF token probe
    ...
    it('update patches and refreshes', async () => {
        ...
        const call = global.fetch.mock.calls[2]
