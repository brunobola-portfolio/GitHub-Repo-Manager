...
- [ ] My code follows the project's code style (JSX only, Tailwind CSS, no global CSS selectors)
- [ ] I have tested my changes locally (`npm run dev:all`)
- [ ] All tests pass (`npx vitest run && npm run lint`)
